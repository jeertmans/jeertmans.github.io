---
title: "ICMLCN 2025 - Towards Generative Ray Path Sampling for Faster Point-to-Point Ray Tracing"
categories:
  - Research
  - Software
tags:
...
image:
  path: /assets/img/posts/barcelona.webp
...
description: Posters and 3-minute thesis video presented at ICMLCN 2025!
---

At ICMLCN 2025, I presented our paper
*Towards Generative Ray Path Sampling for Faster Point-to-Point Ray Tracing*
{% cite Eert2505:Towards %}. This work is the result of a collaboration with Professors Vittorio Degli-Esposti and Enrico Maria Vitucci's laboratory
...
{% include pdf-preview.html url="/assets/pdf/2025-05-27-icmlcn-paper-poster.pdf" ratio=141.38 %}

### Demo poster

{% include pdf-preview.html url="/assets/pdf/2025-05-27-icmlcn-demo-poster.pdf" ratio=141.38 %}
