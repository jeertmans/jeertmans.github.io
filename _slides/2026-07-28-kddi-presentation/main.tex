...
\subtitle{Jérome Eertmans~---~Visiting Researcher at KDDI Research}
...
\newcommand{\ja}[1]{{\color{textmuted}\footnotesize\begin{CJK}{UTF8}{min}（#1）\end{CJK}}}
...
\begin{frame}{Hello! \ja{自己紹介}}
  \begin{columns}[c]
    ...
    \begin{itemize}
      \item \textbf{Name:} Jérome Eertmans
      \item \textbf{Age:} 27 years old
      ...
      \item \textbf{Languages:} French \ja{フランス語} (native), English \ja{英語}, Dutch \ja{オランダ語}, Italian \ja{イタリア語} (basics), Japanese \ja{日本語} (beginner \ja{初級})
    \end{itemize}

    \column{0.35\textwidth}
    \centering
    \includegraphics[height=0.65\textheight]{images/profile.jpg}\\[4pt]
    {\small Jérome Eertmans}
  \end{columns}
\end{frame}
...
\begin{frame}{My Research Topic \ja{研究テーマ}}
  ...
  \begin{columns}[c]
    ...
    \centering
    \includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{images/street_canyon.png}\\[4pt]
    {\footnotesize Radio wave propagation in a street canyon}
  \end{columns}
\end{frame}
...
% ------------------------------------------------------------------
\begin{frame}{Why KDDI Research \& Internship Goals \ja{KDDI総合研究所での研究目標}}
  \begin{columns}[T]
    \column{0.5\textwidth}
...
\begin{frame}{}
  ...
  \begin{center}
    ...
    {\Large \begin{CJK}{UTF8}{min}ご清聴ありがとうございました\end{CJK}}\\[18pt]
...
% ------------------------------------------------------------------
\begin{frame}{Backup: Academic Supervisors \& Publications \ja{補足：指導教員・論文}}
  \begin{columns}[c]
    \column{0.5\textwidth}
    \centering
  ...
  \vspace{6pt}
  \begin{itemize}
    \item \textbf{EuCAP 2026 Best Propagation Paper Award} (\emph{Fast, Differentiable, GPU-Accelerated Ray Tracing})
    \item Submitted to \emph{npj Wireless Technology} (2026)
  \end{itemize}
\end{frame}
