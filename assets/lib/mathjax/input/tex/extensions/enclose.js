!(function () {
        ...
        (t.ENCLOSE_OPTIONS = {
          ...
          (t.EncloseMethods.Enclose = function (a, e) {
            var o = a.GetArgument(e).replace(/,/g, " "),
              n = a.GetBrackets(e, ""),
              i = a.ParseArg(e),
              l = r.default.keyvalOptions(n, t.ENCLOSE_OPTIONS);
            (l.notation = o), a.Push(a.create("node", "menclose", [i], l));
          }),
          new n.CommandMap("enclose", { enclose: "Enclose" }, t.EncloseMethods),
          (t.EncloseConfiguration = o.Configuration.create("enclose", {
  ...
  (a = n(955)),
    (t = n(272)),
    (0, a.r8)({
      _: { input: { tex: { enclose: { EncloseConfiguration: t } } } },
    });
})();
