...
(function (self, undefined) {
  ...
  function UTF16Encoding(n) {
    return n <= 65535
      ? n
      : [Math.floor((n - 65536) / 1024) + 55296, ((n - 65536) % 1024) + 56320];
  }
  !(function (t) {
    "use strict";
    function e(t) {
      ...
      (function () {
        try {
          ...
          return !(
            ...
            !Object.prototype.hasOwnProperty.call(r, "1") ||
            "foo" !== r[0] ||
            "foo" !== r[1] ||
            1 !== r[2] ||
            3 !== r.length
  ...
  if (!("find" in Array.prototype)) {
    CreateMethodProperty(Array.prototype, "find", function e(r) {
      ...
      for (
        var o = arguments.length > 1 ? arguments[1] : undefined, a = 0;
        a < n;
  ...
  if (!("hypot" in Math)) {
    CreateMethodProperty(Math, "hypot", function t(n, r) {
      ...
      for (var i = 0, e = 0, a = 0; a < arguments.length; ++a) {
        ...
        f > e && ((i *= Math.pow(e / f, 2)), (e = f)),
          (0 === f && 0 === e) || (i += Math.pow(f / e, 2));
      }
    ...
    !(function () {
      ...
      Object.defineProperty(e, "name", {
        get: function c() {
          ...
          return (
            n !== e &&
              Object.defineProperty(n, "name", { value: t, configurable: !0 }),
            t
          );
        },
        configurable: !0,
  ...
  if (
    ...
    !(function (e) {
      CreateMethodProperty(Object, "seal", function t(c) {
        return "object" === Type(c) ? c : e ? e(c) : c;
      });
    })(Object.seal);
  }
  ...
  if (!("fromCodePoint" in String && 1 === String.fromCodePoint.length)) {
    CreateMethodProperty(String, "fromCodePoint", function r(o) {
      for (
        var t = [], e = arguments, n = arguments.length, a = [], i = 0;
        i < n;
        ...
        var l = e[i],
          p = ToNumber(l);
        if (!1 === SameValue(p, ToInteger(p)))
          throw new RangeError(
            "Invalid code point " + Object.prototype.toString.call(p),
          );
        if (p < 0 || p > 1114111)
          throw new RangeError(
            "Invalid code point " + Object.prototype.toString.call(p),
        ...
        IsArray(c) ? (a = a.concat(c)) : a.push(c),
          (i += 1),
  ...
  if (
    !("Symbol" in self && "iterator" in self.Symbol && !!Array.prototype.keys)
  ) {
  ...
  if (
    !(
      "Symbol" in self &&
      "iterator" in self.Symbol &&
      !!String.prototype[self.Symbol.iterator]
    )
  ) {
  ...
  if (
    !(function (e) {
      try {
        if (
          Object.prototype.hasOwnProperty.call(e, "WeakSet") &&
          0 === e.WeakSet.length
        ) {
          var t = {},
            r = new e.WeakSet([t]);
