      ...
      163: (e) => {
        e.exports = function (e) {
          ...
          function s(t, l) {
            var o,
              ...
              d = l.appendChild(
                ...
                e.includeHtml && o.childNodes.length
                  ? n.call(o.childNodes, function (e) {
          ...
          function a(t) {
            ...
            return (
              t &&
                ((o += i + e.collapsibleClass), (o += i + e.isCollapsedClass)),
            ...
            updateToc: function (s) {
                  ...
                  (function () {
                    ...
                    "auto" === e.fixedSidebarOffset &&
                      ...
                      n > e.fixedSidebarOffset
                        ? -1 === l.className.indexOf(e.positionFixedClass) &&
                          (l.className += i + e.positionFixedClass)
              ...
              if (r && null !== t && f.length > 0) {
                l.call(f, function (t, n) {
                  return c(t) > a + e.headingsOffset + 10
                    ? ((u = f[0 === n ? n : n - 1]), !0)
                    : n === f.length - 1
                    ? ((u = f[f.length - 1]), !0)
                    : void 0;
                ...
                g &&
                  -1 === g.className.indexOf(e.activeListItemClass) &&
                  (g.className += i + e.activeListItemClass);
                ...
                n.call(v, function (t) {
                  ...
                  h &&
                    h.nextSibling &&
                    -1 !==
                      h.nextSibling.className.indexOf(e.isCollapsedClass) &&
                    (h.nextSibling.className = h.nextSibling.className
                      .split(i + e.isCollapsedClass)
                      .join("")),
            ...
            (r =
              ...
              typeof (l = (function (e) {
                      ...
                      if (u) {
                        ...
                        var p = (function (e) {
                          try {
                            return (
                              e.contentElement ||
                              document.querySelector(e.contentSelector)
                            );
                          } catch (t) {
                            return (
                              console.warn(
                        ...
                        if (null !== p) {
                          ...
                          if (
                            null !== C &&
                            null !==
                              (o = l.selectHeadings(p, i.headingSelector))
                          ) {
                ...
                function h(e) {
                  try {
                    return (
                      e.tocElement || document.querySelector(e.tocSelector)
                    );
                  } catch (t) {
                    return (
      ...
      279: (e) => {
        e.exports = function (e) {
          ...
          function o(t) {
            ...
            return (
              e.includeHtml && (o.childNodes = t.childNodes),
                      ...
                      (function (t, l) {
                        for (
                          var r = o(t),
                            ...
                            s = l,
                            a = n(s),
                            c = i - (a ? a.headingLevel : 0);
                          c > 0 && (!(a = n(s)) || i !== a.headingLevel);

                        )
                          a && void 0 !== a.children && (s = a.children), c--;
